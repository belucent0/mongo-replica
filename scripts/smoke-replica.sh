...
#
# infra-image-release 템플릿이 `bash scripts/smoke-replica.sh "$IMG"` 로 호출한다.
...
ADM="mongodb://root:%23CiSmoke123!@mongo1:27017,mongo2:27017/admin?replicaSet=rs0&authSource=admin"
APP="mongodb://root:%23CiSmoke123!@mongo1:27017,mongo2:27017/ci?replicaSet=rs0&authSource=admin"
